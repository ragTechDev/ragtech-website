---
title: "Is Coding Still Relevant in 2026?"
slug: "is-coding-still-relevant"
author:
  name: "Natasha"
...
newsletter:
  ...
  topic:
    - "ragTech"
seo:
  metaDescription: "Is coding still relevant in 2026? Three software engineers discuss how AI is changing software engineering, what skills matter now, and why coding fundamentals are more important than ever."
  keywords: ["is coding still relevant", "coding in 2026", "AI coding agents", "agentic software engineering", "vibecoding", "software engineering career", "learn to code", "AI and programming"]
instagramEmbeds:
tiktokEmbeds:
---
...
![History of Programming Languages](https://miro.medium.com/v2/resize:fit:1054/1*swfsqh86qDQ-U0bTUpQ0vA.png)

At each stage of inventing newer programming languages, there was always an attempt to make the language less tedious to write, and closer to human language. Each had its own specific function, optimized for specific machines and ways of logic. To date, there is an estimated [14,000 programming languages](https://zorgle.co.uk/how-many-coding-languages-are-there-an-overview-of-the-main-programming-languages-in-use-today/).
...
![Example of an AI Coding Agent](https://zencoder.ai/hubfs/Coding%20Agent%20-%2016_9%20-%20Dark-1.png)
...
![The Future of Software Engineering Jobs](https://www.secondtalent.com/wp-content/uploads/2026/01/swe-jobs-high-demand-roles.png)

Other than the expect rise in demand for AI/ML engineers, Saloni hypothesized that [software engineers affiliated with data centers](https://sg.indeed.com/career-advice/finding-a-job/what-does-data-centre-engineer-do) could become a role in higher demand. DevOps (Development Operations) engineers or Platform Engineers are also one such role that could be in high demand, suggests Natasha, our ragtech co-host and software engineer. With AI democraztizing app deployment, more applications than ever are being deployed on the internet and definitely more code is being shipped, thus requiring more DevOps engineers to manage the increased load of app deployments and maintaining them. 
...
![Software Engineers Do not Just Write Code](https://media.licdn.com/dms/image/sync/v2/D4D27AQGA7iWYeEBPig/articleshare-shrink_800/articleshare-shrink_800/0/1739599797087?e=2147483647&v=beta&t=1ZVfKOoPsQXaMrSWpEYkp5Ssn4Cx3YD7u0oPeVgz-H0)
...
![Agentic Software Engineering](https://d24hrkfl5wrd0k.cloudfront.net/uploads/2025/09/Agentic_AI_blog-2-1024x676.jpg)
...
This ends up with many vibecoded apps being deployed that have major security flaws. Incidents like [Moltbook, the AI agent social platform that was vibecoded](https://www.prplbx.com/blog/moltbook-breach-incident-brief) and exposed the API keys of 1.5 Million users' agents, are occuring at a higher frequency than before largely due to this fact.

![Moltbook](https://assets.apidog.com/blog-next/2026/02/10.JPG)
