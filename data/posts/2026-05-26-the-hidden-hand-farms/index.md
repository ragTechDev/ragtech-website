---
title: "The Hidden Hand Farms: How India Became the World's Motion Capture Lab for AI Robots"
slug: "the-hidden-hand-farms"
author:
  name: "Saloni Kaur"
  profilePicture: "/assets/team/saloni.PNG"
publishedAt: "2026-05-26"
coverImage: "/posts/2026-05-26-the-hidden-hand-farms/cover-image.svg"
brief: "Inside the factories where human hands are being recorded, frame by frame, to teach machines how to replace them."
tags: ["AI", "robotics", "India", "physical AI", "egocentric data", "automation", "ethics", "labour", "data"]
status: "published"
topic:
  - "ragTech"
readTimeInMinutes: 9
...
![A worker wearing a head-mounted GoPro camera performing repetitive tasks in a data capture lab](https://cdn.quasa.io/photos/00/2025-11-06-17-50-58-1.jpg)
*A worker in a data capture lab, GoPro strapped to their forehead, recording motion data for AI training. Source: [Quasa.io](https://quasa.io/media/the-hidden-hand-farms-of-india-fueling-the-ai-robot-revolution-with-human-motion)*
...
According to a [report by Stellaris Venture Partners](https://www.stellarisvp.com/blog/physical-ai-has-a-massive-data-problem), leading robotics labs need 100 million to 1 billion hours of egocentric data in the next two to three years. At an estimated cost of $15–50 per hour of collected footage, that implies a cumulative market spend of $1.5 billion to $50 billion.
...
1. [The Economic Times — "Egocentric data collection fuels AI robotics growth in India" (May 2026)](https://economictimes.indiatimes.com/tech/startups/egocentric-data-collection-fuels-ai-robotics-growth-in-india/articleshow/130477296.cms) — Profiles Humyn AI, Objectways, FPV Labs, Neo Cambrian, and the scale of demand from robotics labs.

2. [Times Now — "Big Tech May Be Using Indian Factory Workers To Train AI" (May 20, 2026)](https://www.timesnownews.com/technology-science/big-tech-may-be-using-indian-factory-workers-to-train-ai-article-154359535) — Reporting on Pearl Global Industries, Egolab.AI, worker conditions, and surveillance concerns.

3. [India Times — "Why are Indian factory workers wearing head-mounted cameras?" (May 2026)](https://www.indiatimes.com/trending/why-are-indian-factory-workers-wearing-head-mounted-cameras-viral-videos-spark-fears-they-are-training-ai-systems-that-could-replace-their-jobs/articleshow/130240716.html) — Overview of data capture labs, viral footage, and labour concerns.

4. [Stellaris Venture Partners — "Physical AI Has a Massive Data Problem" (2026)](https://www.stellarisvp.com/blog/physical-ai-has-a-massive-data-problem) — Venture thesis on the egocentric data bottleneck, the data pyramid, and market sizing ($1.5B–$50B cumulative spend).

5. [Humanoids Daily — "Build AI Scales to 100,000 Hours as Data Scaling Becomes Robotics' New Frontier" (May 2026)](https://www.humanoidsdaily.com/news/build-ai-scales-to-100-000-hours-as-data-scaling-becomes-robotics-new-frontier) — Technical details on Build AI's Egocentric-100K dataset, funding, and the scaling thesis.

6. [ManuData](https://manudata.ai/) — Company website and methodology. Multi-camera depth capture, 3D body/hand pose extraction, 6DoF object tracking across Indian MSMEs.

7. [Quasa.io — "The Hidden 'Hand Farms' of India: Fueling the AI Robot Revolution with Human Motion" (May 2026)](https://quasa.io/media/the-hidden-hand-farms-of-india-fueling-the-ai-robot-revolution-with-human-motion) — Overview of data capture labs, worker conditions, and the economics of annotation labor.
...
9. [NDTV Profit — "Big Tech Using Data From Indian Factory Workers' Wearable Cameras To Train Robots" (May 2026)](https://www.ndtvprofit.com/business/big-tech-uses-indian-factory-workers-data-from-wearable-cameras-to-train-robots-11522030) — Reporting on viral factory videos and the Egolab.AI connection.

10. [News18 — "Cameras On Their Heads While They Work?" (April 2026)](https://www.news18.com/viral/cameras-on-their-heads-while-they-work-viral-factory-videos-from-india-trigger-automation-panic-online-ws-l-10030022.html) — Coverage of the viral Pearl Global footage and public reaction.

11. [SHIRO BPO](https://www.shirobpo.com/) — Mysore-based data annotation services for humanoid robotics, including 3D point cloud labeling and sensor fusion.

12. [Sentientx](https://www.sentientx.io/) — Robotics training data collection including teleoperation, motion capture, and real-world RL data with India operations.
