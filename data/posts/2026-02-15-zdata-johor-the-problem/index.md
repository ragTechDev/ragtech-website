...
Sounds reasonable, right? Except there's a problem.

## What Their Loan Application Actually Says

In 2025, Zdata applied for a USD $40 million equity investment from the Asian Infrastructure Investment Bank (AIIB) as part of their Series C funding round. The project is called ["Project Forest"](https://www.aiib.org/en/projects/details/2025/proposed/china-project-forest.html), and it's meant to finance Zdata's expansion across China and Southeast Asia.
...
Here's another critical detail that makes this project different: **the Zdata facility is located less than one kilometer from residential homes.**

This is unusual. Most data centers in Malaysia—and globally—are built in:
- Dedicated industrial parks
- Former plantation lands
- Areas far from residential dwellings

According to the [South China Morning Post](https://www.scmp.com/news/asia/southeast-asia/article/3342822/malaysias-data-centre-boom-faces-backlash-residents-protest-over-dust-water-woes), "The Gelang Patah project is unusually close to a residential area. By contrast, a majority of completed facilities and ongoing data centre constructions are taking place in former plantations or dedicated industrial land, far from residential dwellings."
...
The Zdata project received approval before this ban. But here's the critical question: **What tier is the Zdata facility?**

State officials have not disclosed this information. And Zdata hasn't clarified it either.

According to [Mordor Intelligence's study on data center water consumption in Malaysia](https://www.mordorintelligence.com/industry-reports/study-of-data-center-water-consumption-in-malaysia), Malaysia's data center water consumption is expected to reach **37.73 billion liters in 2025** and grow at a CAGR of 19.80% to reach **93.09 billion liters by 2030**.
...
For a company now claiming that dust pollution concerns are "inaccurate," this track record doesn't inspire confidence.

## Who Is Zdata?

Zdata Technologies is a leading third-party data center developer and operator in China. According to their AIIB loan application:

- **Capacity in service**: 547MW across 22 data centers as of 2024
- **Projected capacity**: Over 1.0GW by end of 2025
...
Here's something that raises additional red flags: Zdata applied for the AIIB loan in 2025—the same year they broke ground on the Johor facility. Phase 1 was completed in February 2026, meaning they were actively constructing while simultaneously seeking $40 million in Series C funding.

But that's not all. In September 2025, [Zdata was also seeking around USD $500 million (RM 2.1 billion) in private debt](https://www.malaymail.com/news/money/2025/09/12/chinas-zdata-eyes-rm21b-funding-to-expand-johor-data-centre-amid-ai-boom/190857) specifically to fund the Johor data center project. The planned loan could have a tenure of two to three years.

So to be clear: They're seeking both equity financing (the $40M AIIB loan) **and** private debt financing ($500M) while the project is already under construction. This isn't just unusual—it's a significant red flag about project capitalization.

This timing is unusual and potentially risky.

In typical infrastructure development, you secure financing **before** breaking ground, not during construction. Starting construction while still fundraising suggests one of several scenarios:

**Best case:** They had initial capital but need additional funding for later phases or other projects in their pipeline.

**Concerning case:** They underestimated costs, encountered unexpected expenses (like the stop-work order and required remediation), or are experiencing cash flow constraints.

**Strategic case:** They're using the partially-completed Johor project as proof of execution to secure better loan terms.

Regardless of which scenario is accurate, the combination of factors is problematic:

1. **The stop-work order** likely incurred remediation costs, project delays, potential penalties, and increased oversight expenses
2. **The AIIB loan requirements** mandate developing a comprehensive Environmental and Social Management System (ESMS), conducting Environmental and Social Due Diligence (ESDD), and preparing a Stakeholder Engagement Plan (SEP)
3. **But the Johor project is already under construction**—meaning they're trying to retrofit compliance after the fact

This creates a problematic sequence:
- Start building without proper community engagement
- Face protests and regulatory issues  
- Apply for loan that requires the very practices you didn't implement
- Try to retrofit compliance while managing community backlash

**The Grievance Mechanism That Wasn't There**

Here's perhaps the most telling contradiction: The AIIB loan application commits Zdata to establishing a **Project Grievance Redress Mechanism (GRM)** that would "provide a formal, accessible, and transparent process in addressing the concerns from both workers and affected communities related to Project activities."

The GRM is supposed to include:
- Multiple channels for submission
- Documentation and monitoring of grievances
...
If the GRM existed and was functioning as promised, the protest might never have happened. Residents would have had a formal channel to raise concerns, receive timely responses, and see their issues addressed. Instead, they had to organize a public demonstration just to be heard.

This isn't just a failure of community engagement—it's a failure to implement the very commitments Zdata made to secure international financing.

For a company claiming to be "one of the few players in China capable of building, operating and maintaining hyperscale data centers" with 547MW already in operation, needing a $40M equity injection during an active project raises questions about:
- Whether they're expanding beyond their capital base
- Their ability to secure commercial financing
- Their overall risk profile

The AIIB's own documentation categorizes this as "Category B" with "limited" environmental and social impacts that are "not unprecedented." But the protest, media coverage, and contradictory statements suggest otherwise—which creates reputational risk for the lender.
...
**Equinix**, one of the world's largest data center providers and a direct peer of Zdata, takes a fundamentally different approach. According to Raouf Abdel, Equinix's executive vice-president of global operations, the company **engages with local communities up to a year before construction begins** to avoid backlash.

A year. Before breaking ground.
...
**Water recycling systems**: Advanced facilities use gray water and closed-loop cooling systems that minimize freshwater consumption.
...
Here's what frustrates me as an engineer: **Zdata's approach is penny-wise and pound-foolish.**

By not engaging with the community early, by building unusually close to residential areas, by not being transparent about water consumption, and by having a track record of construction violations, Zdata has created a situation where:

1. **Trust is broken**: Even if they implement better practices now, residents have no reason to believe them
2. **Regulatory scrutiny increases**: Officials are now watching this project more closely
3. **Reputational damage spreads**: This protest made international news, affecting Zdata's ability to operate in other markets
...
Let me be clear about something: **I am not anti-AI. I am not a doomsayer afraid of technological progress or job losses.**

I'm a software engineer. I work in this industry. I'm genuinely excited about what AI and advanced computing can do for society.

But precisely because I know how this technology works, I have a responsibility to advocate for doing it right.
...
1. **Early community engagement** (Equinix's model)
2. **Transparent disclosure** of tier classifications and resource consumption
3. **Sustainable cooling technologies** that reduce water and energy use
4. **Renewable energy commitments** to minimize carbon impact
5. **Strategic location selection** away from residential areas
6. **Robust environmental impact assessments** before construction begins
...
And as someone who builds technology for a living, I refuse to stay silent when I see it being done irresponsibly.

---

**References:**
- [ZDATA Technologies Responds To Protests Of AI Datacentre In Johor - Lowyat.NET](https://www.lowyat.net/2026/382868/zdata-technologies-responds-to-protests-of-ai-datacentre-in-johor/)
- [China: Project Forest - AIIB](https://www.aiib.org/en/projects/details/2025/proposed/china-project-forest.html)
- [Malaysia's data centre boom faces backlash as residents protest over dust, water woes - SCMP](https://www.scmp.com/news/asia/southeast-asia/article/3342822/malaysias-data-centre-boom-faces-backlash-residents-protest-over-dust-water-woes)
- [Study Of Data Center Water Consumption In Malaysia - Mordor Intelligence](https://www.mordorintelligence.com/industry-reports/study-of-data-center-water-consumption-in-malaysia)
...
- [Johor halts data centre approvals - Lowyat.NET](https://www.lowyat.net/2025/374704/johor-data-centre-approvals/)
